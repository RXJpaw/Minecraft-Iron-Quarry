...
public class ZBlocks {
    public static final BlockEntryBuilder COPPER_QUARRY = new BlockEntryBuilder()
            .setBlock(new QuarryBlock(Blocks.COPPER_BLOCK, "block/copper_quarry",1, 40, 12_000, 48))
